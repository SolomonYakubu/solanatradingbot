...
interface SetDefaultWalletSceneState {} // No specific state needed

const setDefaultWalletScene = new Scenes.WizardScene<MyContext>(
  "setDefaultWallet",
  async (ctx) => {
    await ctx.reply(
      "🔑 *Send the Solana wallet address you want to set as default:*\n\n" +
