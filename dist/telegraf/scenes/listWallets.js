...
const listWalletsScene = new Scenes.BaseScene("listWallets");
listWalletsScene.enter(async (ctx) => {
    const wallets = ctx.user.wallets;
    if (!wallets || wallets.length === 0) {
        await ctx.reply("No wallets found. Please create one.", Markup.inlineKeyboard([
        ...
        await ctx.replyWithMarkdownV2(escapedMsg, Markup.inlineKeyboard([
...
//# sourceMappingURL=listWallets.js.map